use lsp_types::{
  ...
  CodeActionLiteralSupport, CodeLensClientCapabilities, CodeLensWorkspaceClientCapabilities,
  CompletionClientCapabilities, CompletionItemKind, CompletionItemKindCapability,
  CompletionListCapability, DiagnosticClientCapabilities, DiagnosticTag,
  ...
  DynamicRegistrationClientCapabilities, FoldingRangeCapability, FoldingRangeClientCapabilities,
  FoldingRangeKind, FoldingRangeKindCapability, GeneralClientCapabilities, GotoCapability,
  HoverClientCapabilities, InlayHintClientCapabilities, InlayHintResolveClientCapabilities,
  InlayHintWorkspaceClientCapabilities, InlineValueWorkspaceClientCapabilities, InsertTextMode,
  MarkdownClientCapabilities, MarkupKind, MessageActionItemCapabilities, PositionEncodingKind,
  PrepareSupportDefaultBehavior, PublishDiagnosticsClientCapabilities, ReferenceClientCapabilities,
  RegularExpressionsClientCapabilities, RenameClientCapabilities, ResourceOperationKind,
  SelectionRangeClientCapabilities, SemanticTokenModifier, SemanticTokenType,
  SemanticTokensClientCapabilities, SemanticTokensClientCapabilitiesRequests,
  SemanticTokensFullOptions, SemanticTokensWorkspaceClientCapabilities,
  ...
  StaleRequestSupportClientCapabilities, SymbolKind, SymbolKindCapability, SymbolTag, TagSupport,
